...
[{"PROVIDER_SLUG_NAME": "mockup-server-oidc", "PROVIDER_DISPLAY_NAME":"Mockup Server OIDC","CLIENT_ID":"${OIDC_CLIENT_ID}","CLIENT_SECRET":"${OIDC_COOKIE_SECRET}","DISCOVERY_ENDPOINT":"${OIDC_SERVER_METADATA_URL}","USER_ID_ATTRIBUTE":"${USER_ID_ATTRIBUTE}","USER_DISPLAY_NAME_ATTRIBUTE":"${USER_DISPLAY_NAME_ATTRIBUTE}","USER_MAIL_ATTRIBUTE":"${USER_MAIL_ATTRIBUTE}"}]
EOF
)
