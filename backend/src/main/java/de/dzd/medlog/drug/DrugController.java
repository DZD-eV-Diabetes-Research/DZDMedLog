...
import de.dzd.medlog.drug.association.ATCRepository;
import de.dzd.medlog.drug.association.ProducerRepository;
        ...
        if (page.isEmpty() && size.isEmpty()) {
            ...
            List<Sort.Order> orders = multiSortMeta.stream()
                    .map(order -> {
                        ...
                        Sort.Direction direction = Integer.parseInt(order[1]) < 0 ? Sort.Direction.DESC
                                : Sort.Direction.ASC;
