...
public class InterviewExportService {
    ...
    public String getInterviewsAsCsv() {
        ...
        StringBuilder interviewCsv = new StringBuilder(
                "ID;ProbantID;EventID;InterviewNr;Startdate;Enddate;HasTakenOtherDrugs;DrugNr,DrugName,ATC,Dose,IsPrescribed,IsRegularIntake,IntakeStartDate,IntakeEndDate,DosesPerDay,IntakeInterval,IsTakenToday\n");
