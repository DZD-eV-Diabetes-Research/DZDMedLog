    ...
    <template #body>
      <form @submit.prevent="submitForm">
        <div class="form__group">
          ...
          <input id="user_mail" name="user_mail" type="email" v-model.trim="email" class="input-field">
          <label for="display_name">Display Name</label>
          <input id="display_name" name="Display Name" type="text" v-model.trim="displayName" class="input-field">
