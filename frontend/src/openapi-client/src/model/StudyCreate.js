...
class StudyCreate {
    ...
    constructor(id, name) { 
        ...
        StudyCreate.initialize(this, id, name);
    }
...
StudyCreate.RequiredProperties = ["id", "name"];

/**
 * @member {module:model/DisplayName} display_name
 */
StudyCreate.prototype['display_name'] = undefined;

/**
 * @member {Boolean} deactivated
 * @default false
 */
StudyCreate.prototype['deactivated'] = false;
 ...
 * @default false
 */
StudyCreate.prototype['no_permissions'] = false;

/**
 * @member {module:model/Id} id
 */
StudyCreate.prototype['id'] = undefined;
 ...
 * @member {String} name
 */
StudyCreate.prototype['name'] = undefined;
