...
/**
 * The IntakeCreate model module.
 * @module model/IntakeCreate
 * @version 0.0.1
 */
class IntakeCreate {
    /**
     * Constructs a new <code>IntakeCreate</code>.
     ...
     * @alias module:model/IntakeCreate
    ...
    constructor(id, interviewId, pharmazentralnummer, intakeStartTimeUtc, asNeededDoseUnit, consumedMedsToday) { 
        ...
        IntakeCreate.initialize(this, id, interviewId, pharmazentralnummer, intakeStartTimeUtc, asNeededDoseUnit, consumedMedsToday);
    }
    ...
    /**
     * Constructs a <code>IntakeCreate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IntakeCreate} obj Optional instance to populate.
     * @return {module:model/IntakeCreate} The populated <code>IntakeCreate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IntakeCreate();
    ...
    /**
     * Validates the JSON data with respect to <code>IntakeCreate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IntakeCreate</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of IntakeCreate.RequiredProperties) {
...
IntakeCreate.RequiredProperties = ["id", "interview_id", "pharmazentralnummer", "intake_start_time_utc", "as_needed_dose_unit", "consumed_meds_today"];

/**
 * @member {module:model/Id} id
 */
IntakeCreate.prototype['id'] = undefined;

/**
 * @member {module:model/InterviewId} interview_id
 */
IntakeCreate.prototype['interview_id'] = undefined;
 ...
 */
IntakeCreate.prototype['pharmazentralnummer'] = undefined;

/**
 * @member {Date} intake_start_time_utc
 */
IntakeCreate.prototype['intake_start_time_utc'] = undefined;

/**
 * @member {module:model/IntakeEndTimeUtc} intake_end_time_utc
 */
IntakeCreate.prototype['intake_end_time_utc'] = undefined;

/**
 * @member {module:model/IntakeAdministeredByDoctor} administered_by_doctor
 */
IntakeCreate.prototype['administered_by_doctor'] = undefined;

/**
 * @member {module:model/IntakeIntakeRegularOrAsNeeded} intake_regular_or_as_needed
 */
IntakeCreate.prototype['intake_regular_or_as_needed'] = undefined;

/**
 * @member {module:model/DosePerDay} dose_per_day
 */
IntakeCreate.prototype['dose_per_day'] = undefined;

/**
 * @member {module:model/IntakeRegularIntervallOfDailyDose} regular_intervall_of_daily_dose
 */
IntakeCreate.prototype['regular_intervall_of_daily_dose'] = undefined;

/**
 * @member {module:model/AsNeededDoseUnit} as_needed_dose_unit
 */
IntakeCreate.prototype['as_needed_dose_unit'] = undefined;

/**
 * @member {module:model/ConsumedMedsTodayAnswers} consumed_meds_today
 */
IntakeCreate.prototype['consumed_meds_today'] = undefined;
