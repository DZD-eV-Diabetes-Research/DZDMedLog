...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MedLogRestApi.HTTPValidationError();
  });
  ...
  describe('HTTPValidationError', function() {
    it('should create an instance of HTTPValidationError', function() {
      ...
      //var instance = new MedLogRestApi.HTTPValidationError();
      //expect(instance).to.be.a(MedLogRestApi.HTTPValidationError);
    });
