...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MedLogRestApi.ValidationErrorLocInner();
  });
  ...
  describe('ValidationErrorLocInner', function() {
    it('should create an instance of ValidationErrorLocInner', function() {
      ...
      //var instance = new MedLogRestApi.ValidationErrorLocInner();
      //expect(instance).to.be.a(MedLogRestApi.ValidationErrorLocInner);
    });
