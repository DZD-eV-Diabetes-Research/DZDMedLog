...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MedLogRestApi.IntakeCreate();
  });
  ...
  describe('IntakeCreate', function() {
    it('should create an instance of IntakeCreate', function() {
      // uncomment below and update the code to test IntakeCreate
      //var instance = new MedLogRestApi.IntakeCreate();
      //expect(instance).to.be.a(MedLogRestApi.IntakeCreate);
    });
