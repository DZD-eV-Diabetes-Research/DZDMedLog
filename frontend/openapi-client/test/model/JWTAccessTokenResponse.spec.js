...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MedLogRestApi.JWTAccessTokenResponse();
  });
  ...
  describe('JWTAccessTokenResponse', function() {
    it('should create an instance of JWTAccessTokenResponse', function() {
      // uncomment below and update the code to test JWTAccessTokenResponse
      //var instance = new MedLogRestApi.JWTAccessTokenResponse();
      //expect(instance).to.be.a(MedLogRestApi.JWTAccessTokenResponse);
    });
