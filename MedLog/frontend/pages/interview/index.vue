            ...
            <div class="p-4" style="text-align: center">
                <UForm :schema="interviewSchema" :state="interviewState" class="space-y-4" @submit="createInterview()">
                    ...
                    <URadioGroup v-model="selected" style="border: 'border border-black'"
                        ...
                        :options="options" />
                    <!-- <UCommandPalette v-model="selectedEvent" nullable :autoselect="false"
                        :groups="[{ key: 'event', commands: studyEvents }]" :fuse="{
                            resultLimit: 5, fuseOptions: {
                                ignoreLocation: true,
                                includeMatches: true, threshold: 0.1
                            }
                        }" /> -->
                    ...
                    <UAccordion :items="accordionItems" :is-open="true">
                        <template #create-event>
