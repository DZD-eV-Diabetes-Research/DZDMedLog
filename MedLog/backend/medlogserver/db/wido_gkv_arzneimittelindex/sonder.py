...
from medlogserver.model.wido_gkv_arzneimittelindex.sonder import (
    Sondercodes,
)
...
class SondercodesCRUD(
    create_drug_crud_base(
        table_model=Sondercodes,
        read_model=Sondercodes,
        create_model=Sondercodes,
        update_model=Sondercodes,
    )
):
    pass
